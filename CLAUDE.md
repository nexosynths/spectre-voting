...
- [x] 34 passing contract tests, 28 passing SDK tests
- [x] Human-readable error messages — `friendlyError()` decodes 18 contract custom errors into user-friendly strings
